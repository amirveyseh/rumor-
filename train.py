...
parser.add_argument('--data_dir', type=str, default='dataset/twitter/twitter15')
parser.add_argument('--vocab_dir', type=str, default='dataset/vocab15')
...
for epoch in range(1, opt['num_epoch']+1):
    ...
    for i, batch in enumerate(train_batch):
        ...
        global_step += 1
        loss, loss_pred = trainer.update(batch)
